  ...
  logo: (
    <span className="navbar__brand">
      <span className="navbar__logo">
        <img src="/assets/img/logo@96px.png" alt="Plaice Fish" />
      </span>
      <span className="navbar__title">{config.title}</span>
    </span>
  ),
  project: {
    link: PROJECT,
      ...
      <div className="footer-text">
        ...
        <a href="https://vercel.com?utm_source=plaiceholder&utm_campaign=oss">
          <svg
            ...
            fill="none"
          >
            <rect width="212" height="44" rx="8" fill="transparent" />
            <path
            ...
            />
            <path
              d="M23.3248 13L32.6497 29H14L23.3248 13Z"
              fill="currentColor"
            />
            <line
              x1="43.5"
        ...
        images: [
          {
            ...
            width: 1200,
            height: 628,
            alt: "Plaice fish, acompanied by text. Plaiceholder. Beautiful image placeholders, without the hassle. Choose-your-own adventure, from pure CSS to SVG.",
            type: "image/png",
          },
        ],
      },
