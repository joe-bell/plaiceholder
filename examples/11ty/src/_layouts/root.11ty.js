  ...
  <body id="root" class="preload">
    <header class="${layoutHeader()}">
      <div class="${layoutHeaderContainer()}">
        <a class="${logo()}" href="/">
          <span class="${logoBrand()}">${data.config.project}</span>
          <span class="${logoIcon()}">
            <img
          ...
          <span class="${logoTitle()}">${data.config.title}</span>
        </a>
        ...
        <ul class="${socialList()}">
          <li class="${socialListItem()}">
            <a
              ...
              class="${iconLink()}"
            >
              <span class="${iconLinkLabel()}">View the GitHub repo</span>
              <svg
                class="${icon()}"
          ...
          <li class="${socialListItem()}">
            <a
              ...
              class="${iconLink()}"
            >
              <span class="${iconLinkLabel()}">Contact the author on Twitter</span>
